 ...
 * generated in the org.ouyushan.cxf.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetUser_QNAME = new QName("http://ws.cxf.ouyushan.org/", "getUser");
    private final static QName _GetUserList_QNAME = new QName("http://ws.cxf.ouyushan.org/", "getUserList");
    private final static QName _GetUserListResponse_QNAME = new QName("http://ws.cxf.ouyushan.org/", "getUserListResponse");
    private final static QName _GetUserName_QNAME = new QName("http://ws.cxf.ouyushan.org/", "getUserName");
    private final static QName _GetUserNameResponse_QNAME = new QName("http://ws.cxf.ouyushan.org/", "getUserNameResponse");
    private final static QName _GetUserResponse_QNAME = new QName("http://ws.cxf.ouyushan.org/", "getUserResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.ouyushan.cxf.ws
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.cxf.ouyushan.org/", name = "getUser")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.cxf.ouyushan.org/", name = "getUserList")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.cxf.ouyushan.org/", name = "getUserListResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.cxf.ouyushan.org/", name = "getUserName")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.cxf.ouyushan.org/", name = "getUserNameResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.cxf.ouyushan.org/", name = "getUserResponse")
