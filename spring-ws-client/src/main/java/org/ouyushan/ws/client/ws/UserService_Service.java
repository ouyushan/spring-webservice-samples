 ...
 * 2020-11-04T16:00:55.988+08:00
 * Generated source version: 3.4.0
 *
 */
@WebServiceClient(name = "UserService",
                  wsdlLocation = "classpath:wsdl/user.wsdl",
                  targetNamespace = "http://cxf.ouyushan.org/")
public class UserService_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://cxf.ouyushan.org/", "UserService");
    public final static QName UserServiceImplPort = new QName("http://cxf.ouyushan.org/", "UserServiceImplPort");
    static {
        URL url = null;
        try {
